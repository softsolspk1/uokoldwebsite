...
<div class="news_box">
      <h3>Latest</h3>
        <div class="news_scroll"><a href="/semesterfees/instructions.php">Semester Fee </a> | <a href="/news/2021/cnku.jpg" target="_blank"> UoK Updates </a> | <a href="/ann_results/docs/2021/abds.pdf" target="_blank"> B.A Schedule</a> | <a href="/ann_results/docs/2021/csbds.pdf" target="_blank"> B.Sc Schedule</a><span id="blink"> </span>    
                
        </div>
        
   </div> 
<!-- <span class="apply_now"> </span><br class="clear" /></span> -->
     </div>   
        ...
        <div class="col_home">
          <div class="col_left">
                ...
                <div class="content_news" id="tab1">
			        ...
			        <li>
              <div class="news_desc">
                      <h3>Date Sheets for B.A & B.Sc Exams</h3>
     <p><a href="/ann_results/docs/2021/abds.pdf" target="_blank"> B.A Schedule </a> | <a href="/ann_results/docs/2021/csbds.pdf" target="_blank"> B.Sc Schedule</a> (27JUL2021)</p></div>
     				</li>
                     <li>
                     <div class="news_desc">
                     <h3>B.A & B.Sc (Reg) Fee Schedule</h3>
                     <p><a href="/news/2021/bascnd.jpg" target="_blank"> Click here</a> (27JUL21)</p>   
                     </div>
                     </li>
                     <li>
                     <div class="news_desc">
                     <h3>B.A (Ext) Examination Fee Schedule</h3>
                     <p><a href="/news/2021/abexteef.jpg" target="_blank"> Click here</a> (27JUL21)</p>   
                     </div>
                     </li>
                ...
                <ul>
                     <li>
                     <div class="news_desc">
                     <h3><strong>MBBS / BDS Exams Results 2021</strong></h3>
                     <p><a href="/ann_results/docs/2021/fpmbbsxxi.pdf" target="_blank"> M.B.B.S. </a> | <a href="/ann_results/docs/2021/fpbdsxxi.pdf" target="_blank"> B.D.S </a> (25JUN21)</p>
                     </div>
                     </li>
                     <li>
                     <div class="news_desc">
                     <h3><strong>MBBS / BDS Supplementary 2020 </strong></h3>
                     <p><a href="/ann_results/docs/2021/mbbsfsxx.pdf" target="_blank">M.B.B.S </a> | <a href="/ann_results/docs/2021/bdsfsxx.pdf" target="_blank"> B.D.S</a> (09JUN21)</p>
                     </div>
                     </li>
                     <li>
                     <div class="news_desc">
                     <h3><strong>LL.M Annual Exam 2019</strong></h3>
                     <p><a href="/ann_results/docs/2021/llmpxix.pdf" target="_blank">Previous</a>(19APR21) | <a href="/ann_results/docs/2021/llmgfxix.pdf" target="_blank"> Final</a> (09JUN21)</p>
                     </div>
                     </li>
        ...
        <!--           <div class="search_course">
         ...
         <div class="search_course">
                  ...
                  <div class="search_box_course">
                    <p>Registration of B.A (Pass) ::  <a href="/news/2021/xxbaerxix.jpg" target="_blank"> Click here</a><br/>Registration of B.Com ::  <a href="/news/2021/babcreg.jpg" target="_blank"> Click here</a><br/>Registration of M.A :: <a href="/news/2021/xxmaerxix.jpg" target="_blank"> Click here</a>
          </div>
                </div>
            </div> 
           ...
           <div class="col_right"><a href="/administration/vc.php" target="_blank"><img src="/images/banner-joinus-ki.jpg"  width"220" height="246" alt="V.C." /></a></div>
      </div>
        <br class="clear" />
    </div>
