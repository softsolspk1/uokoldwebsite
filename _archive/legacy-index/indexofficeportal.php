        ...
        <div class="col_home">
          <div class="col_left">
                ...
                <div class="content_news" id="tab1">
			        ...
			        <li>
              <div class="news_desc">
                    <h3>B.Sc Practical Annual Exams 2022</h3>
                    <p>Zoology: <a href="/news/2023/bsczpaexxii.jpg" target="_blank"> Click here</a> (22AUG2023)</p></div>
     				</li>
                    <li>
              <div class="news_desc">
                    <h3>B.Sc Practical Annual Exams 2022</h3>
                    <p>Chemistry: <a href="/news/2023/bscchempxii.jpg" target="_blank"> Click here</a> (09AUG2023)</p></div>
     				</li>
                    <li>
              <div class="news_desc">
                    <h3>Thesis Annual Examination 2021</h3>
                    <p>LL.M (Final) <a href="/news/2023/llmfthaexxi.pdf" target="_blank"> Click here </a> (04AUG2023)</p></div>
     				</li>
                ...
                <ul>
                   <li>
                     <div class="news_desc">
                     <h3><strong>M.A. (Ext) Annual Examination 2021</strong></h3>
                     <p>Economics : <a href="/ann_results/docs/2023/mafecoxxi.pdf" target="_blank">Final</a> (15AUG2023)</p>
                     </div>
                  </li>
                   <li>
                     <div class="news_desc">
                     <h3><strong>M.A (Ext) Annual Examination 2021</strong></h3>
                     <p>Previous:<a href="/ann_results/docs/2023/mafaegisxxi.pdf" target="_blank"> ECO-G.HIS </a> | Final:<a href="/ann_results/docs/2023/mapaeecogisxxi.pdf" target="_blank"> G.HIS</a> (25JUL2023)</p>
                     </div>
                     </li>
                   <li>
                     <div class="news_desc">
                     <h3><strong>BDS Supplementary Exams 2022</strong></h3>
                     <p><a href="/ann_results/docs/2023/bdsiipsxxii.pdf" target="_blank">2nd PRO</a> | <a href="/ann_results/docs/2023/bdsiiipsxxii.pdf" target="_blank">3rd PRO</a> | <a href="/ann_results/docs/2023/bdsfpsxxii.pdf" target="_blank">Final PRO</a> (11JUL2023)</p>
                     </div>
                     </li>
