...
<div class="news_box">
      <h3>Latest</h3>
        <div class="news_scroll"><a href="/semesterfees/instructions.php"><font size="+0.1">Semester Fee</font></a>   
...
<div id="outer_content">
    <div id="content">
          ...
          <div class="col_left">
                ...
                <div class="content_news" id="tab1">
                    <ul>
			         <li>
              <div class="news_desc">
                    <h3>LLM (Final) Annual Exam 2023</h3>
                    <p>Thesis: <a href="/news/2026/llmth.pdf" target="_blank"> Click here</a> (18AUG2026)</p></div>
     				</li>
			        <li>
              <div class="news_desc">
                    <h3>Revised Dates of Postpone Papers</h3>
                    <p>Notification: <a href="/news/2026/rdppsalh.jpg" target="_blank"> Click here</a> (28JUL2026)</p></div>
     				</li>
			        <li>
              <div class="news_desc">
                    <h3>M.Ed Annual Examinations 2024</h3>
                    <p>Schedule: <a href="/news/2026/pmed.jpg" target="_blank"> Click here</a> (17JUL2026)</p></div>
     				</li>
                ...
                <li>
                     <div class="news_desc">
                     <h3><strong>M.B.B.S. Annual Examination 2026</strong></h3>
                     <p><a href="/ann_results/docs/2026/mbsivp.pdf" target="_blank"> 4th-PRO</a> (22JUL2026)</p>
                     </div>
                     </li>
                <li>
                     <div class="news_desc">
                     <h3><strong>B.D.S.  Annual Examination 2026</strong></h3>
                     <p><a href="/ann_results/docs/2026/bdsiip.pdf" target="_blank"> 2nd-PRO</a> (22JUL2026)</p>
                     </div>
                     </li>
                <li>
                     <div class="news_desc">
                     <h3><strong>MBBS Annual Examination 2026</strong></h3>
                     <p>MODULAR: <a href="/ann_results/docs/2026/mbbsiiipm.pdf" target="_blank"> IIIrd-PRO</a> (22APR2026)</p>
                     </div>
                     </li>
       ...
       <div class="search_course">
           ...
           <div class="col_right"><a href="/administration/vc.php" target="_blank"><img src="/images/banner-joinus-dmt.jpg"  width"220" height="246" alt="V.C." /></a></div>
      </div>
